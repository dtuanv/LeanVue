    ...
    <q-card class="my-card">
      ...
      <q-card-actions vertical>
        <q-form @submit="itemCheckOut">
          <!-- Input Validation -->
          <q-input v-model="user.name" class="col-4" label="Name" color="white"   :rules="[val => !!val && val.length > 1 || 'Please write a correct name']"></q-input>
...
// });
  ...
  return{
    ...
    hashmap,
    // input validation
    adresseRules:[val => (val !== null && val !== '' ) && !!val || 'Please write your adresse!!'],
    mobilRules: [val => (val !== null  && val !== '' ) && !!val  || 'Please write a correct mobil',
                   val => (val.includes(0) && !!val || 'A Mobil nummer must start with a  0')
            ],
